 ...
 *
 * Return: A numerical value of the card.
 */
char get_value(deck_node_t *card)
{
...
/**
 * insertion_sort_deck_kind - A sort a deck of cards from spades to diamonds.
...
/**
 * insertion_sort_deck_value - A sort a deck of cards sorted from
...
/**
 * sort_deck - A sort a deck of cards from ace to king and
